...
public:
    ...
    void SmashedThroughBuildingPiece(const FVector& ImpactPoint, const FVector& ImpactNormal);
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FName GetVehicleJumpActionName(AFortPlayerPawn* FortPlayerPawn) const;
