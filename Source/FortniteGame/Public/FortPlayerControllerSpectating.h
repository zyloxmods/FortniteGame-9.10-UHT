...
class UFortSpectatorSettings;
class UInputComponent;
class UMaterialInterface;
class UPostProcessComponent;

UCLASS(Blueprintable)
class FORTNITEGAME_API AFortPlayerControllerSpectating : public AFortPlayerControllerGameplay {
    GENERATED_BODY()
public:
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSubclassOf<ABattleMapPawn> BattleMapPawnClass;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TMap<FString, UAthenaPlayerMatchReport*> PlayerMatchReports;
...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UFortSpectatorSettings* SpectatorSettings;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    UFortSpectatorSettings* GetSpectatorSettings_BP() const;
