...
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_PendingDeath, meta=(AllowPrivateAccess=true))
    bool bPendingDeath;
...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_CurrentServerPhysicsState, meta=(AllowPrivateAccess=true))
    FTimeStampedPhysicsPawnState CurrentServerPhysicsState;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_LastServerConfirmedHit, meta=(AllowPrivateAccess=true))
...
protected:
    ...
    FPhysicsObjectInitialParameters InitialParameters;
...
public:
    ...
    static APhysicsObject* SpawnPhysicsObject(const UObject* WorldContextObject, TSubclassOf<APhysicsObject> ActorClass, const FTransform& Transform, const FPhysicsObjectInitialParameters& NewInitialParameters);
