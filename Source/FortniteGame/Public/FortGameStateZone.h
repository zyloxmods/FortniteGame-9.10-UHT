...
protected:
    ...
    FPlayerBuildableClassContainer PlayerBuildableClasses[4];
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool GetVoteStartTime(EFortVoteType VoteType, FDateTime& VoteStartTime) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool GetVoteInstigator(EFortVoteType VoteType, FUniqueNetIdRepl& InstigatorNetId) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool GetVoteEndTime(EFortVoteType VoteType, FDateTime& VoteEndTime) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool CanSpawnDefender(AFortPlayerStateZone* PlayerCausingRemoval, const FName& RemoveFromDefenderSquadId, AFortAIPawn*& OutDefenderToBeRemoved) const;
