...
AFortMission::AFortMission() {
    ...
    this->BotLogicClass = NULL;
    this->BotLogic = NULL;
    this->MissionGenerator = NULL;
    this->MissionCategory = EMissionGenerationCategory::Primary;
    this->UIIndex = -1;
    this->bLoadedFromRecord = false;
    this->bFiredParTimeEvent = false;
    this->MissionActivationTime = -1.00f;
    this->bSilentDestroyNextFrame = false;
    this->MissionStatus = EFortMissionStatus::Created;
    this->bIsMissionVisible = true;
    this->MissionAudibility = EFortMissionAudibility::UseVisibility;
    this->CurrentObjectiveBlockIndex = 0;
    this->bIsMissionVisibleOverride = true;
    this->StartingDay = -1;
    this->TimerComponent = NULL;
    this->TimerElapsedComponent = NULL;
    this->bObjectiveTimerExpireShouldFailObjectives = false;
    this->bMissionTimerExpireShouldFailMission = false;
    this->bNeedsEnemyKilledEventForAllPawns = false;
    this->ChosenRewardIdx = -1;
}
