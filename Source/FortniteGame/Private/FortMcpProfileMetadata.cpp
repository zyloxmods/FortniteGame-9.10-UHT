...
void UFortMcpProfileMetadata::UpdateDeployableBaseTierProgression_Implementation(const FString& DeployableBaseItemId, const FString& ProgressionLayoutGuid, int32 TierDefeated, FDedicatedServerUrlContext& Context) {
}

void UFortMcpProfileMetadata::CreateOrUpgradeOutpostItem_Implementation(const FString& TemplateId, FClientUrlContext& Context) {
}
