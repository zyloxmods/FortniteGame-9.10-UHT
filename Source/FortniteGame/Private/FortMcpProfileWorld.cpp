...
void UFortMcpProfileWorld::FabricateItem_Implementation(const FString& TemplateId, FDedicatedServerUrlContext& Context) {
}

void UFortMcpProfileWorld::DisintegrateItems_Implementation(const TArray<FString>& itemsToDisintegrateIds, const TArray<int32>& itemCountsToDisintegrate, FDedicatedServerUrlContext& Context) {
}
