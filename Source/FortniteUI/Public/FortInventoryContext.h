...
#include "OnPinnedSchematicsChangedDelegateDelegate.h"
...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnPinnedSchematicsChangedDelegate OnPinnedSchematicsChanged;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    bool SetSchematicPinned(UFortSchematicItem* Schematic, bool bEnabled);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool IsSchematicPinned(UFortSchematicItem* Schematic) const;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static TArray<FText> GetUserFriendlyTags(const UFortItem* Item);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool GetSupportBonusPerks(UFortHero* Hero, TArray<FFortUIPerk>& SupportBonusPerks) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void GetPinnedSchematicList(TArray<UFortSchematicItem*>& PinnedItems) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool CanPinSchematic(UFortSchematicItem* Schematic) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool CanItemBeMulched(UFortItem* Item, FText& OutRestrictionReasons) const;
