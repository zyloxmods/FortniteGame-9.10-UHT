...
#include "LobbyBackgroundChangedDelegateDelegate.h"
#include "LobbyEmptyPlayerClickedDelegateDelegate.h"
#include "LobbyPlayerGadgetsClickedDelegateDelegate.h"
#include "LobbyPlayerHoveredDelegateDelegate.h"
#include "LobbyPlayerPadHoveredDelegateDelegate.h"
#include "LobbyPlayerPadUnhoveredDelegateDelegate.h"
#include "LobbyPlayerPartySuggestionAcceptDelegate.h"
#include "LobbyPlayerSelectedDelegateDelegate.h"
#include "LobbyPlayerUnhoveredDelegateDelegate.h"
#include "LobbyPlayerUnselectedDelegateDelegate.h"
...
public:
    ...
    FLobbyBackgroundChangedDelegate OnLobbyBackgroundChanged;
    ...
    UPROPERTY(BlueprintAssignable, BlueprintCallable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FLobbyPlayerPadHoveredDelegate OnLobbyPlayerPadHovered;
    
    UPROPERTY(BlueprintAssignable, BlueprintCallable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FLobbyPlayerPadUnhoveredDelegate OnLobbyPlayerPadUnhovered;
    
    UPROPERTY(BlueprintAssignable, BlueprintCallable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FLobbyPlayerHoveredDelegate OnLobbyPlayerHovered;
    
    UPROPERTY(BlueprintAssignable, BlueprintCallable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FLobbyPlayerUnhoveredDelegate OnLobbyPlayerUnhovered;
    
    UPROPERTY(BlueprintAssignable, BlueprintCallable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FLobbyPlayerSelectedDelegate OnLobbyPlayerSelected;
    
    UPROPERTY(BlueprintAssignable, BlueprintCallable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FLobbyPlayerUnselectedDelegate OnLobbyPlayerUnselected;
...
public:
    ...
    void ViewVaultItemsFromOffer(const FCatalogOffer& CatalogOffer, bool bIgnoreCurrentlyEquppedFavorites);
    
    UFUNCTION(BlueprintCallable)
    void ViewVaultItems(const TArray<UFortItem*>& ItemsToView, bool bIgnoreCurrentlyEquppedFavorites);
    
    UFUNCTION(BlueprintCallable)
    void ViewVaultItemFromDefinition(const UFortItemDefinition* ItemToViewDefinition, bool bIgnoreCurrentlyEquppedFavorites);
    
    UFUNCTION(BlueprintCallable)
    void ViewVaultItem(UFortItem* ItemToView, bool bIgnoreCurrentlyEquppedFavorites);
    ...
    UFUNCTION(BlueprintCallable)
    void SetLocalVariantPreview(const UAthenaCosmeticItemDefinition* CosmeticItem, FGameplayTag VariantChannelTag, FGameplayTag VariantTag);
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FName GetLobbyBackgroundLevelName() const;
