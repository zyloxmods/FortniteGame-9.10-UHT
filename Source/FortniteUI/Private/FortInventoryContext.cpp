...
bool UFortInventoryContext::SetSchematicPinned(UFortSchematicItem* Schematic, bool bEnabled) {
    return false;
}
...
bool UFortInventoryContext::IsSchematicPinned(UFortSchematicItem* Schematic) const {
    return false;
}
...
TArray<FText> UFortInventoryContext::GetUserFriendlyTags(const UFortItem* Item) {
    return TArray<FText>();
}
...
bool UFortInventoryContext::GetSupportBonusPerks(UFortHero* Hero, TArray<FFortUIPerk>& SupportBonusPerks) const {
    return false;
}
...
void UFortInventoryContext::GetPinnedSchematicList(TArray<UFortSchematicItem*>& PinnedItems) const {
}
...
bool UFortInventoryContext::CanPinSchematic(UFortSchematicItem* Schematic) const {
    return false;
}

bool UFortInventoryContext::CanItemBeMulched(UFortItem* Item, FText& OutRestrictionReasons) const {
    return false;
}
